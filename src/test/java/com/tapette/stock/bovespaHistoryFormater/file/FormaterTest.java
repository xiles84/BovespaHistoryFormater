...
public class FormaterTest {
	...
	public void testExecute() throws Exception {
		Formater form = new Formater("C:\\Users\\Xiles84\\Downloads\\Java\\GIT\\BovespaHistoryFormater\\src\\test\\resources\\stocks") {
			int count = 0;
			protected String readLine(BufferedReader reader) throws IOException {
				...
				if(count == 1)
					...
					return "012017010212ABCP12      010FII ABC IMOBCI  ER       R$  000000000118300000000011830000000001101000000000116200000000011360000000001138000000000120500019000000000000001210000000000001407143000000000000009999123100000010000000000000BRABCPCTF000255";
				else if( count == 3)
		...
		form.execute();
		System.out.println(form.getList().get(0).getStockEntryName());
		...
		Formater form = new Formater("") {
			...
			protected String readLine(BufferedReader reader) throws IOException {
				...
				if(count == 1)
					...
					return "012017010212ABCP13      010FII ABC IMOBCI  ER       R$  000000000118300000000011830000000001101000000000116200000000011360000000001138000000000120500019000000000000001210000000000001407143000000000000009999123100000010000000000000BRABCPCTF000255";
				else if( count == 3)
					return "99COTAHIST.2017BOVESPA 2017090600000330110                                                                                                                                                                                                           ";
				return null;
			};
